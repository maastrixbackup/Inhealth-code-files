   ...
   <div id="login_content">
       <div id="sign_profile"></div>
                ...
                <form  method="post" name="chat_app" id="chat_app" action="group_chat.php">
                   <p>     <input class="form-control " type="text" placeholder="Email Id" name="email" id="email" >
                     
                
                        <input class="form-control "  type="password" style="float: left;" placeholder="Password" name="password" id="password" > 
                        &nbsp;
                        
                        <input class=" " type="image" name="log" value="login" style="float: right;" src="images1/login.png" id="btnValidate">

                        
                       
                  </p>
                    <span class="e_msg"> <div class="clear"></div>
                      <?php 
