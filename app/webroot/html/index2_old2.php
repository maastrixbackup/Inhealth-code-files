...
/*if(isset($_SESSION['loginType']) && $_SESSION['loginType']=='D'){ 
        ...
        if(mysql_num_rows($appointDetails)>0){
            ...
            $appoint_id = $appointDetail['id'];  
			$conv_start_time=$appointDetail['conv_start_time'];
        }
...
/*if(isset($_SESSION['loginType']) && $_SESSION['loginType']=='P'){
    ...
    if(mysql_num_rows($appointPatientDetails)>0){
            ...
            $appoint_id = $appointPatientDetail['id'];
        }
...
/*if(isset($_SESSION['conv_end_time'])){
	$cur_time=date('H:i:s');
...
<!--<div class="pl j-pl hidden">-->
            ...
            <section class="experiment">                
                <section id="margindel-video" >
                    ...
                    <button id="setup-new-room" class="setup startconference_btn">Start Conference</button>
                    <?php //}?>
                </section>
...
<?php }?>
<!--============Browser or tab close function call==============-->
<!--<script type="text/javascript">
