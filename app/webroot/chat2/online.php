...
function ChangeStatus(val1,val2){
	//alert(val);
    
    $.post('<?php echo URL ?>chatbox.ajax.php', {add_chatuser: 'true',id:val1,appid:val2,regularapp:true}, function(data, textStatus, xhr) {
		//alert(data);
...
/* function ChangeStatusRegular(val){
	//alert(val);
    
    $.post('<?php echo URL ?>chatbox.ajax.php', {add_chatuser: 'true',appid:val,regularapp:true}, function(data, textStatus, xhr) {
		//alert(data);
     window.location.href = window.location.href;
    });
...
 
 ...
 <!-- <span class="ui-widget-header tag_line_user">Welcome  <?php //echo $user_det->user_name; ?></span>-->
