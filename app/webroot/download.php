...
//path to the file
$file_path='files/backup_db/'.urldecode($_REQUEST['filename']);
$fileprefix=urldecode($_REQUEST['fileprefix']);
$fileprefix=preg_replace('/[^A-Za-z0-9\-]/', '-', $fileprefix);
$fileprefix=strtolower($fileprefix);
//Call the download function with file path,file name and file type
output_file($file_path, $fileprefix, 'application/x-sql');
