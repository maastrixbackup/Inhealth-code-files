            ...
            <?php echo $this->Form->create('MasterDoctor', array('enctype' => 'multipart/form-data')); ?>
                <div class="box-body">
                 ...
                 <?php echo $this->Form->input('lname',array('label'=>'Last Name','type'=>'text', 'class' => 'form-control', 'div' => 'form-group'));
                    ...
                    echo $this->Form->input('attr_field.hospitalid',array('label'=>'Select Hospital', 'name' => 'data[attr_field][hospitalid]','type'=>'select', 'options' => $hospitalList, 'class' => 'form-control', 'div' => 'form-group'));
                 	//echo $this->Form->input('hospital_name',array('label'=>'Hospital Name','name' => 'data[Hospital][hospital_name]','type'=>'text', 'class' => 'form-control', 'div' => 'form-group'));
                 	//echo $this->Form->input('hospital_detail',array('label'=>'Hospital Details/Location','name' => 'data[Hospital][hospital_detail]','type'=>'textarea', 'class' => 'form-control', 'div' => 'form-group'));
                      ...
                      echo $this->Form->input('AssignService.serviceid',array('label'=>'Select Services', 'name' => 'data[AssignService][serviceid]','type'=>'select', 'multiple' => 'multiple', 'options' => $serviceList, 'class' => 'form-control', 'div' => 'form-group', 'required' => 'required'));
                    ?>
                 <h4 class="box-title">Lgoin Details</h4>
                    <?php
                     ...
                     echo $this->Form->input('user_pass',array('label'=>"Password",'type'=>'password', 'class' => 'form-control', 'div' => 'form-group'));
                 ...
                 <?php 	
                 echo $this->Form->input('attr_field.address',array('label'=>'Address', 'name' => 'attr_field[address]', 'required' => 'required','type'=>'text', 'class' => 'form-control', 'div' => 'form-group'));				
