...
$(function() {
    ...
    $('#doctor').change(function() {
        ...
        $.ajax({
                   type:"POST",
                   url:"<?php echo $base_url;?>admin/Appointments/availbility",
                   data:dataVal,
                   success: function(data){
    ...
    $('#AppointmentAppointmentAvailbility').change(function() {
        ...
        $.ajax({
                   type:"POST",
                   url:"<?php echo $base_url;?>admin/Appointments/availbility_slot",
            ...
            <?php echo $this->Form->create('Appointment'); ?>
                <div class="box-body">
                 ...
                 <?php echo $this->Form->input('serviceid',array('label'=>'Select Services','type'=>'select', 'multiple' => 'multiple', 'class' => 'form-control','id'=>'service', 'div' => 'form-group', 'options' => $serviceList));
                 	...
                 	<?php
                    echo $this->Form->input('appointment_availbility',array('label'=>'Doctor Available Time','type'=>'select', 'options' => '', 'class' => 'form-control', 'div' => 'form-group'));
                    ?>
                    
                    <?php
                    	echo $this->Form->input('appoint_book_slut',array('label'=>'Appointment slot','type'=>'select', 'options' => '', 'class' => 'form-control', 'div' => 'form-group'));
                    ?>
