...
<html>
    <head>
        ...
        <link href="<?php echo $base_url;?>myadmin/css/iCheck/all.css" rel="stylesheet" type="text/css" />
        <!-- Bootstrap Color Picker -->
        <link href="<?php echo $base_url;?>myadmin/css/colorpicker/bootstrap-colorpicker.min.css" rel="stylesheet"/>
