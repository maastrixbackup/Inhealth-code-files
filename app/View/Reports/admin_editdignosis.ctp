    ...
    <div class="col-md-8">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Update Diagnosis</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <?php echo $this->Form->create('DiagnosysReport');
            echo $this->Form->input('id');
            //$testList=$this->Custom->BapCustUnitestDignosisList($this->request->data['DiagnosysReport']['id']);
             ?> 
                <div class="box-body">
                  ...
                  <?php /*?><div class="form-group">
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <?php if(count($testList)<=0){?>
                                    ...
                                    <?php 
                                    $testcount=1;
                                    foreach ($testList as $testReult) {
                                     ?>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="new_box<?php echo $testcount;?>">
                                        <?php if($testcount>1){?>
                                          <tr><th align="right" valign="middle" scope="col" style="padding-bottom:5px;"><input type="button" onclick="closeInfoDesc(<?php echo $testcount;?>)" value="&times;" /></th></tr>
                                          <?php }?>
                                          <tr>
                                            <th align="left" valign="middle" scope="col" style="padding-bottom:5px;">Select Test</th>
                                          </tr>
                                          <tr>
                                            <th align="left" valign="middle" scope="col" style="padding-bottom:15px;">
                                                <?php echo $this->Form->input('testid',array('name' => 'data[DiagnosysTest][testid][]', 'label' => false, 'default'=>0, 'class' => 'form-control', 'div' => 'form-group', 'options' => $testparentList, 'selected' => $testReult['DiagnosysTest']['test_type']));?>
                                            </th>
                                          </tr>
                                          <tr>
                                            <th align="left" valign="middle" scope="col" style="padding-bottom:5px;">Test Result</th>
                                          ...
                                          <tr>
                                            <th align="left" valign="middle" scope="col" style="padding-bottom:15px;">
                                                 <?php echo $this->Form->input('test_res',array('name' => 'data[DiagnosysTest][test_res][]', 'label'=>false,'type'=>'text', 'class' => 'form-control', 'div' => 'form-group', 'value' => $testReult['DiagnosysTest']['test_result']));?>
                                            </th>
                                          </tr>
                                        </table>
                                        <?php 
                                    ...
                                    <tr>
                                        <td colspan="2">
                                        <input type="hidden" name="slider_count" id="slider_count" value="<?php echo (count($testList)>0)?count($testList) : 1;?>" />
