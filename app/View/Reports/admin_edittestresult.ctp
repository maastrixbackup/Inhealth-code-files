    ...
    <div class="col-md-8">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Update Test Result</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            ...
            //$testList=$this->Custom->BapCustUnitestDignosisList($this->request->data['DiagnosysReport']['id']);
             ?> 
                ...
                <?php echo $this->Form->input('sub_test_type',array('label' => 'Select Sub Test',  'class' => 'form-control', 'div' => 'form-group','options' => $subtestList));?>
