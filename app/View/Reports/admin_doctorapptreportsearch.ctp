...
<?php
 ...
 $serchdate1=date('Y-m-d',strtotime($serchdate1)); 
?>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-tools">
                                        <div class="input-group">
                                            ...
                                            <input type="text"  placeholder="Select Date" name="srchdate1" id="srchdate1" class="form-control input-sm pull-right datepicker" value="<?php echo $serchdate1;?>" style="width: 150px;"/>
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                       ...
                                       <tr>
                                            <td><?php echo $cnt; ?>&nbsp;</td>
                                            <td><?php echo $docDetail=$this->Custom->userDet($appointment[$controll]['doctorid']); ?>&nbsp;</td>
                                            <td><?php echo $patientDetail=$this->Custom->userDet($appointment[$controll]['patientid']); ?>&nbsp;</td>
                                            <!-- <td>
                                           <?php 
                                           ...
                                           <td><?php echo h(date("d-m-Y H:i:s",strtotime($appointment[$controll]['created']))); ?>&nbsp;</td>
