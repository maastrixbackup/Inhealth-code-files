    ...
    <div class="col-md-8">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Uploaded Report</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            ...
            ?> 
                <div class="box-body">
                 ...
                 <?php 
                    echo $this->Form->input('uploaded_file',array('label'=>'Upload Test Report','type'=>'file', 'class' => 'form-control','id'=>'uploaded_file', 'div' => 'form-group','required'=>false));
                    if($this->request->data['UploadtestResult']['uploaded_file']!=""){?>
                    <div class="form-group">
                      <a href="<?php echo $this->webroot.'files/testresult/'.$this->request->data['UploadtestResult']['uploaded_file'];?>" style="float:left; width:15%; color:white;" class="btn btn-info" target="_blank">View Report</a>&nbsp; &nbsp;
                    </div>  
                  <?php  }
                 ?>
