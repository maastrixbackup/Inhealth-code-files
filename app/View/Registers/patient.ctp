...
<div class="innerpage_banner"><div class="innerpage_banner_bgcolor">
    <div class="container">
        <div class="row">
				...
				<h2>Patient Registration - InHealth</h2>
...
<?php echo $this->Form->input('fname',array('label'=>false,'type'=>'text', 'class' => 'register_from_input', 'div' => false));?>
            ...
            <hr class="register_from_clear">	
             ...
             <div class="row">
                ...
                <?php echo $this->Form->input('patient_id',array('label'=>false,'type'=>'text', 'class' => 'register_from_input', 'div' => false, 'required' => 'required'));?>
                </div> -->
                ...
                <?php echo $this->Form->input('dob',array('label'=>false,'type'=>'text', 'class' => 'register_from_input', 'div' => false));?>
                 ...
                 <div class="col-md-6 col-sm-6 register_formbox"><label class="register_from_name">Marital Status</label>
                    <?php echo $this->Form->input('marital_status',array('label'=>false,'type'=>'select', 'options' => array('' => 'Select Status', 'married' => 'Married', 'single' => 'Single', 'divorced' => 'Divorced', 'widowed' => 'Widowed', 'separated' => 'Separated', 'domestic partner' => 'Domestic Partner'), 'class' => 'register_from_input', 'div' => false, 'required' => 'required'));?>
                </div>
            </div>
            ...
            <hr class="register_from_clear">
             ...
             <hr class="register_from_clear">
              ...
              <div class="col-md-6 col-sm-6 register_formbox"><label class="register_from_name">Country</label>
                ...
                <?php echo $this->Form->input('country',array('label'=>false, 'name' => 'attr_field[country]','type'=>'select','options' => $countryList, 'class' => 'register_from_input', 'div' => false));?>
                </div>
                <div class="col-md-6 col-sm-6 register_formbox"><label class="register_from_name">State</label>
                <!-- <textarea name="" cols="" rows="" class="register_from_input"></textarea> -->
                <?php echo $this->Form->input('state',array('label'=>false, 'name' => 'attr_field[state]','type'=>'select','options' => $stateList, 'class' => 'register_from_input', 'div' => false));?>
                </div>
              ...
              <div class="col-md-6 col-sm-6 register_formbox"><label class="register_from_name">City</label>
                <!-- <input name="" type="text" class="register_from_input"> -->
                <?php echo $this->Form->input('city',array('label'=>false, 'name' => 'attr_field[city]','type'=>'text', 'class' => 'register_from_input', 'div' => false));?>
                </div>
                <div class="col-md-6 col-sm-6 register_formbox"><label class="register_from_name">Guardian's Name</label>
                <!-- <textarea name="" cols="" rows="" class="register_from_input"></textarea> -->
                <?php  echo $this->Form->input('guardians_name',array('label'=>false, 'name' => 'attr_field[guardians_name]','type'=>'text', 'class' => 'register_from_input', 'div' => false));?>
                </div>
            </div>   
            <hr class="register_from_clear">
              ...
              <div class="col-md-6 col-sm-6 register_formbox"><label class="register_from_name">Emergency Contact Person</label>
                <!-- <input name="" type="text" class="register_from_input"> -->
                <?php echo $this->Form->input('emrg_contact_per',array('label'=>false, 'name' => 'attr_field[emrg_contact_per]','type'=>'text', 'class' => 'register_from_input', 'div' => false));?>
                </div>
                ...
                <div class="col-md-6 col-sm-6 register_formbox"><?php //echo SECURITYCODE;?><label class="register_from_name">Enter Code</label>
                	<table width="100%" border="0">
                      <tr>
                        ...
                        <td width="50%"> 
						<?php echo $this->Form->input('captcha_text',array('label'=>false, 'type'=>'text', 'class' => 'register_from_input', 'div' => false));?></td>
                      </tr>
                    </table>
                </div>
            </div> 
