    ...
    <div class="row">
           ...
           <!--===================================Profile Detail===================================-->
                ...
                <table class="table table-bordered"> 
                  ...
                  <tbody> 
                    <?php $i=0;
                      if(!empty($docList)) {//pr($docList);
                        foreach ($docList as $doctor): ?>
                          <tr> 
                            <td><?php echo ++$i; ?></td> 
                            <td><a href="<?php echo $base_url."dashboards/viewdoctor/".$doctor['MasterUser']['id'];?>"><?php echo stripslashes($doctor['MasterUser']['fname']." ".$doctor['MasterUser']['lname']);?></a></td> 
                            <td><?php echo stripslashes($doctor['MasterUser']['ref_id']);?></td> 
                            <td><?php echo stripslashes($doctor['MasterUser']['email_id']);?></td>
                            <td><?php echo stripslashes($doctor['MasterUser']['mobile_no']);?></td>
                          </tr> 
                    <?php endforeach; }?>
                  </tbody> 
                </table>
