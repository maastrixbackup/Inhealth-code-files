            ...
            <div class="col-md-8 col-sm-8">
                <?php echo $this->Session->flash(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-6 register_formbox">
                            <label class="register_from_name">Upload Test result</label>
                            <?php echo $this->Form->input('uploaded_file',array('label'=>false,'type'=>'file', 'class' => 'register_from_input','id'=>'uploaded_file', 'div' => false,'required'=>false));?>
                            <a href="<?php echo $this->webroot.'files/testresult/'.$this->request->data['UploadtestResult']['uploaded_file'];?>" style="float:left; width:50%; color:#000;" target="_blank">View Report</a> 
                        </div>  
