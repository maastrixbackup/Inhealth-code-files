                    ...
                    <div class="row">
                        ...
                        <hr class="register_from_clear"> 
                         <div class="col-md-7 col-sm-6 register_formbox required">
                            ...
                            <?php echo $this->Form->input('patientid',array('label'=>false,'type'=>'select','id'=>'patient', 'class' => 'register_from_input', 'div' => false, 'options' => $patientList,'selected'=>$patientid));?>
                        </div>
