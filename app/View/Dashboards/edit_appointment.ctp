                ...
                ?> 
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-6 register_formbox required">
                            ...
                            <?php echo $this->Form->input('doctorid',array('label'=>false,'type'=>'select','id'=>'doctor', 'class' => 'register_from_input datepicker', 'div' => false, 'options' => $doctorList));?>
                        </div>  
...
$(function() {
    ...
    $('#AppointmentAppointmentAvailbility').change(function() {
        ...
        $.ajax({
                   type:"POST",
                   url:"<?php echo $base_url;?>dashboards/availbility_slot/<?php echo $this->request->data['Appointment']['id'];?>",
