                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="input-group">
                                            <input type="text"  placeholder="Select From Date" name="startdate" id="startdate" value="<?php echo $start_date;?>" class="form-control input-sm datepicker" style="width: 150px;margin-right: 10px;"/>
                                            <input type="text"  placeholder="Select To Date" name="enddate" id="enddate" value="<?php echo $end_date;?>" class="form-control input-sm datepicker" style="width: 150px;margin-right: 10px;"/>
