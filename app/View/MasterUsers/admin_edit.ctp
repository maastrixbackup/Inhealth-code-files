<?php
$work_phone = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'work_phone');
$country = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'country');
$state = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'state');
$city = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'city');
$guardians_name = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'guardians_name');
$emrg_contact_per = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'emrg_contact_per');
$hospitalID = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterUser']['id'], 'hospitalid');
if($hospitalID!=''){
            ...
            <div id="err_emailfield">      </div>
                 ...
                 <h4 class="box-title">Lgoin Details</h4>
                    <?php
                     ...
                     echo $this->Form->input('user_pass',array('label'=>"Password",'type'=>'password', 'class' => 'form-control', 'div' => 'form-group','autocomplete' => 'off', 'value' => base64_decode($this->request->data['MasterUser']['user_pass'])));
                     echo $this->Form->input('cnf_pass',array('label'=>'Confirm Password','type'=>'password', 'class' => 'form-control', 'div' => 'form-group','autocomplete' => 'off','value'=> base64_decode($this->request->data['MasterUser']['user_pass'])));
                 ?>
                 ...
                 echo $this->Form->input('address',array('label'=>'Address', 'name' => 'attr_field[address]', 'required' => 'required','type'=>'text', 'class' => 'form-control', 'div' => 'form-group','value' => $address));				
						 ...
						 "onkeypress"=>"this.value = this.value.replace(/[^0-9]/, '')", "onkeyup"=>"this.value = this.value.replace(/[^0-9]/, '')"));
						  ...
						  echo $this->Form->input('country',array('label'=>'Country', 'name' => 'attr_field[country]','type'=>'select','options' => $countryList, 'class' => 'form-control', 'div' => 'form-group', 'selected' => $country));
						  if($country!=''){
						  	$stateList = $this->Custom->BapCustUniGetStateByCountry($country);
						  }
						   echo $this->Form->input('state',array('label'=>'State', 'name' => 'attr_field[state]','type'=>'select','options' => $stateList, 'class' => 'form-control', 'div' => 'form-group', 'selected' => $state));

						    echo $this->Form->input('city',array('label'=>'City', 'name' => 'attr_field[city]','type'=>'text', 'class' => 'form-control', 'div' => 'form-group', 'value' => $city));
						    echo $this->Form->input('guardians_name',array('label'=>"Guardian's Name", 'name' => 'attr_field[guardians_name]','type'=>'text', 'class' => 'form-control', 'div' => 'form-group', 'value' => $guardians_name));
						     echo $this->Form->input('emrg_contact_per',array('label'=>"Emergency Contact Person", 'name' => 'attr_field[emrg_contact_per]','type'=>'text', 'class' => 'form-control', 'div' => 'form-group', 'value' => $emrg_contact_per));
                 ?>
