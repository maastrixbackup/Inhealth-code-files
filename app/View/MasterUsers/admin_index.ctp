 ...
 <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                  ...
                                  <button class="btn btn-primary btn-flat" onclick="location.href='<?php echo $base_url;?>admin/MasterUsers/add'">Add New Patient</button>
                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        <tr>
                                            ...
                                            <th><?php echo $this->Paginator->sort('patient_id', 'Patient ID'); ?></th>
 			 ...
 			 ?></td>
                                            ...
                                            <td><?php echo h($masterUser['MasterUser']['user_name']); ?></td>
                                            <td><?php 
											...
											?></td>
											<td><?php echo h($masterUser['MasterUser']['zipcode']); ?></td>
											<td><?php 
											if($masterUser['MasterUser']['status'] == 1){
											echo $this->Html->link(__('Active'), array('action' => 'set_status_inactive', $masterUser['MasterUser']['id']), array('style' => 'color:green;'));
											}else{
											echo $this->Html->link(__('In-Active'), array('action' => 'set_status_active', $masterUser['MasterUser']['id']), array('style' => 'color:red;'));
											}
											?></td>
											<td><?php echo h(date("d-m-Y",strtotime($masterUser['MasterUser']['created']))); ?>&nbsp;</td>
											<td class="actions">
												<?php echo $this->Html->link(__('View'), array('action' => 'view', $masterUser['MasterUser']['id'])); ?>
												<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $masterUser['MasterUser']['id'])); ?>
												<?php 
												echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $masterUser['MasterUser']['id']), array(), __('Are you sure you want to delete # %s?', $masterUser['MasterUser']['fname'].' '.$masterUser['MasterUser']['lname'])); ?>
											</td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </table>
