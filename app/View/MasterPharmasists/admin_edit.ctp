<?php
$work_phone = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'work_phone');
$country = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'country');
$state = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'state');
$city = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'city');
$guardians_name = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'guardians_name');
$emrg_contact_per = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'emrg_contact_per');
$hospitalID = $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'hospitalid');
if($hospitalID!=''){
...
?>
<?php $address=(isset($this->request->data['attr_field']['address'])) ? $this->request->data['attr_field']['address'] : $this->Custom->BapCustUniGetUserMeta($this->request->data['MasterPharmasist']['id'], 'address');?>
<script>
    ...
    <div class="col-md-6">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title">Edit Pharmasist</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            <?php echo $this->Form->create('MasterPharmasist'); 
                ...
                <div class="box-body">
                 ...
                 <h4 class="box-title">Lgoin Details</h4>
                    <?php
                     ...
                     echo $this->Form->input('user_pass',array('label'=>"Password",'type'=>'password', 'class' => 'form-control', 'div' => 'form-group','autocomplete' => 'off', 'value' => base64_decode($this->request->data['MasterPharmasist']['user_pass'])));
                     echo $this->Form->input('cnf_pass',array('label'=>'Confirm Password','type'=>'password', 'class' => 'form-control', 'div' => 'form-group','autocomplete' => 'off','value'=> base64_decode($this->request->data['MasterPharmasist']['user_pass'])));
                 ?>
